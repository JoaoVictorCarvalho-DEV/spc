    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Novo Sensor</h2>
                <button @click="$inertia.visit(route('sensors.index'))"
            ...
            <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="bg-white shadow rounded-lg overflow-hidden">
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input v-model="form.esp_identifier" type="text"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                                    placeholder="Ex: SEN-001"
                                    :class="{ 'border-red-500': form.errors.esp_identifier }" />
                                <p v-if="form.errors.esp_identifier"
                                    class="mt-1 text-sm text-red-600 flex items-center gap-1">
                                    <AlertCircle :size="12" />
                            ...
                            <!-- <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p v-if="form.errors.type" class="mt-1 text-sm text-red-600">{{ form.errors.type }}
                                    </p>
                                </div>
                            ...
                            <!-- <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input v-model="form.min_value" type="number" step="any"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                                        placeholder="Ex: 0" />
                                    <p class="mt-1 text-xs text-gray-500">
                                        Valor mínimo esperado para leitura
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input v-model="form.max_value" type="number" step="any"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                                        placeholder="Ex: 100" />
                                    <p class="mt-1 text-xs text-gray-500">
                                        Valor máximo esperado para leitura
                                    </p>
                                </div>
                            </div> -->
                    ...
                    <div class="flex items-center justify-end gap-4">
                        <button type="button" @click="$inertia.visit(route('sensors.index'))"
